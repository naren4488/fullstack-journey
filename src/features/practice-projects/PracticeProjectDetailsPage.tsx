...
export function PracticeProjectDetailsPage() {
  ...
  return (
    <Shell>
        ...
        <div className="min-w-40 max-w-md flex-1">
          {prevProject ? (
            <Link
              ...
              className="block rounded-xl p-2 transition hover:bg-stone-100/80"
            >
            ...
            <span className="block p-2 text-sm text-stone-400">
      ...
      <section className="overflow-hidden rounded-4xl border border-stone-200/80 bg-white/85 shadow-[0_20px_80px_rgba(87,57,24,0.10)]">
        <div className="grid gap-8 px-6 py-8 lg:grid-cols-[1.1fr_0.9fr] lg:px-10 lg:py-10">
          <div>
            ...
            {project.whyMatters ? (
              <div className="mt-5 rounded-2xl border border-amber-200/70 bg-amber-50/60 px-4 py-3">
                <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-amber-900">
            ...
            project.recommendedAfterTopics.length > 0 ? (
              <div className="mt-5 rounded-2xl border border-stone-200 bg-stone-50/80 px-4 py-3 text-sm text-stone-700">
                  ...
                  {project.recommendedAfterTopics.map((topic) => (
                    <li key={topic}>
                      <Link
                        ...
                        className="inline-flex rounded-full border border-stone-200 bg-white px-3 py-1 text-xs font-medium text-amber-900 transition hover:border-amber-400"
                      >
                        {topic}
                      </Link>
                    </li>
      ...
      >
        <h2 className="text-xl font-bold text-stone-950 sm:text-2xl">About this project</h2>
        <p className="mt-3 max-w-3xl text-sm leading-7 text-stone-600 sm:text-base">
          {project.summary}
        </p>
        <p className="mt-4 text-sm text-stone-500">
          Use the <strong className="text-stone-700">View code</strong> button at the top for annotated
